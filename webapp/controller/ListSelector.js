sap.ui.define([
	...
	return BaseObject.extend("MyTickets.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias MyTickets.model.ListSelector
		 */
		 ...
		 * @return {MyTickets.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
